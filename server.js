...
app.get('/movies', function(req, res){
  var movies = [
    ...
    {title : 'Ant-Man', release: '2020', score: 8, reviewer: 'Martin Thomas', publication : 'TheOne'},
    {title : 'Guardians of the bahia', release : '2014', score: 10, reviewer: 'Anthony Miller', publication : 'ComicBookHero.com'},
  ]
